...
char insert_##type##_##index_type##_binary_array(                                \
    ...
    size_t index = 0;                                                            \
    if (!n) {                                                                    \
        reset_##type##_##index_type##_binary_array(array);                       \
        return 1 + insert_##type##_##index_type##_binary_array(array, value);    \
    }                                                                            \
                                                                                 \
    n->m_value = value;                                                          \
    n->m_is_node = true;                                                         \
...
int main(void) {
    ...
    scanf("%zu", &size_arr1);
    {
        ...
        preffix_sum_s64_array(arr1, arr1, size_arr1);

        for (size_t i = 0; i < size_arr1; ++i)
            answer += insert_s64_u32_binary_array(cash1, arr1[i]);
